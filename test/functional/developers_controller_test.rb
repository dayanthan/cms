...
class DevelopersControllerTest < ActionController::TestCase
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post :create, developer: { date: @developer.date, designation: @developer.designation, manager: @developer.manager, name: @developer.name, role: @developer.role }
    end
  ...
  test "should update developer" do
    put :update, id: @developer, developer: { date: @developer.date, designation: @developer.designation, manager: @developer.manager, name: @developer.name, role: @developer.role }
    assert_redirected_to developer_path(assigns(:developer))
  end
