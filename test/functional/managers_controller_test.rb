...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { designation: @manager.designation, manager: @manager.manager, name: @manager.name, role: @manager.role }
    end
  ...
  test "should update manager" do
    put :update, id: @manager, manager: { designation: @manager.designation, manager: @manager.manager, name: @manager.name, role: @manager.role }
    assert_redirected_to manager_path(assigns(:manager))
  end
